...
folder_path <- "/data-raw/foehn/data"
...
for(i in 1:8){
  ...
  file = paste0("/data-raw/foehn/data/", file_names[i])
  ...
  # path for file
  path_for_file = paste0("/data/foehn_processed/",station_abbr,"_daily_aggregated.csv")
...
# write NA file
path_for_NA = paste0("/data/NA/NA_record_foehn.csv")
